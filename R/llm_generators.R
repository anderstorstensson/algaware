...
generate_swedish_summary <- function(station_summary, taxa_lookup = NULL,
  ...
  user_prompt <- paste0(
    ...
    "the actual abundance with the unit shown in the data (cells/L, or ",
    "counts/L when only image-based counts are available -- never relabel ",
    "counts/L as cells/L) and the threshold value. ",
...
generate_english_summary <- function(station_summary, taxa_lookup = NULL,
  ...
  user_prompt <- paste0(
    ...
    "with the unit shown in the data (cells/L, or counts/L when only ",
    "image-based counts are available -- never relabel counts/L as cells/L) ",
...
generate_station_description <- function(station_data, taxa_lookup = NULL,
  ...
  user_prompt <- paste0(
    ...
    "levels, you MUST state in the description the actual abundance with the unit ",
    "shown in the data (cells/L, or counts/L when only image-based counts are ",
    "available -- never relabel counts/L as cells/L) and the threshold value ",
    "(e.g. '2 000 cells/L, exceeding the warning level of 1 500 cells/L'). ",
